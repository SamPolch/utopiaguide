...
The page also has a **Build Tool** that lets you save building ratios so new acres can be built in the same proportions as existing land. On the Raze tab the Build Tool fills the amounts to be razed; on the Cancel tab it fills the amounts to be constructed (not the in-progress amounts), so take care when using it there.
...
| Homes | 10 People | 0.3 Peasants |  |  | 35 | 0 | Houses 10 extra people and produces 0.3 peasants per day (Unaffected by BE) |
...
| Training Grounds |  |  | 1.5% / 2% | 37.5% / 50% | 25 | 25 | Increases Offensive Military Efficiency; Reduces Training Time |
...
| Watch Towers |  |  | 2% / 3% | 50% / 62.5% | 25 | 25 | Chance of Catching Enemy Thieves; Reduced damage caused by Enemy Thieves |
| Universities |  |  | 1.5% / 1% | 37.5% / 25% | 25 | 25 | Increase scientist spawn rate (Unaffected by BE); Increases generation of science books in selected Category (Unaffected by BE) |
| Libraries |  |  | 2% | 37.5% | 25 | 25 | Increase Science Efficiency (Unaffected by BE) |
...
There are four classes of building effects, and each functions differently. While this may be difficult to follow, you will quickly understand it with some experience within the game. The four classes are:
...
- **Production Buildings:** This type of building provides a set amount of a particular resource per day and is impacted by Building Efficiency. A Tower, for example, creates a set number of runes each day.
- **Fixed Rate Buildings:** This type of building provides a set output that is unaffected by Building Efficiency. Guilds training wizards and Homes producing peasants are examples.
- **Percentage-based Buildings:** The majority of Utopian buildings are percentage-based. These buildings provide an effect based on the portion of your land covered by them. For example, having 10% of your land as Banks will increase your income by a certain percentage. Like production buildings, these also require employees to provide full effects. In addition, each additional building you construct will be less effective. The numbers listed in this section are for the first building you construct. Your Internal Affairs Advisor will help you understand the benefits of your land. Unless otherwise specified, these buildings have a maximum effect of 25 times the number listed below. With normal building efficiency, this maximum is reached by dedicating 50% of your land to that building.
...
While every built up acre of land already houses people – which means Homes are not a necessity for a province – you may find yourself wanting more population. Homes give your citizens more place to live, and also produce new peasants each day. Furthermore, Homes employ no peasants and will thus overall help you fill all the jobs in your province.

- Increases your maximum population by 10 (on top of the 25 that a built building provides, for a total of 35)
- Produces 0.3 Peasants per Day (Unaffected by BE and production bonuses)
- Employs no one
...
Maintaining a good offense is important for all attackers, and Training Grounds bolster that by providing an enhanced training to all your offensive troops. This allows them to fight more efficiently in combat, thus increasing your overall attacking power. Training Grounds also reduce how long it takes to train new troops.

- Increases Offensive Military Efficiency by % \* 1.5
- Reduces Training Time by % \* 2
...
Castles protect your land and resources, making enemy attacks against your province less efficient. They do not protect honor losses from attacks, science books from Learns, or population from Massacres.

- Decreases Resource (Land, Gold, Food, Runes) Losses when Attacked by % \* 2.25
- Decreases Honor Losses when Attacked by % \* 2
...
Guilds also increase the duration of your self spells and offensive spells, and improve the success rate of self spells and rituals.
...
- Lowers Losses in Thievery Operations by % \* 3.6 (capped at 90%)
- Increases Thievery Effectiveness by % \* 3

### Watch Towers

While your own thieves can protect your land against enemy thieves, a little extra protection is never a bad thing. People assigned into Watch Towers will screen your borders and can catch thieves attempting to conduct operations in your province. Note that Watch Towers do not apply to intel operations.

- % \* 2 Chance of Catching Enemy Thieves
- Reduces damage caused by Enemy Thieves by % \* 3 (capped at 62.5%)

### Universities

Universities increase your scientist generation rate and allow your scientists to produce books more effectively.

- Increase spawn rate of new scientists by % \* 1.5
- % \* 1 Higher Generation of Science Books
...
- % \* 2 Higher Science Efficiency (capped at 37.5%)
...
```
Construction Time = 16 * Racial Mod * Personality Mod * Builders Boon * Double Speed * Haste Ritual Mod * Artisan Science Mod
```
...
| **War** | 0.75 | 1 |
| **[Haste Ritual](../misc/Ritual.md)** | 0.75 (if at 100% efficiency) | 1 |
...
```
Construction Costs = 0.05 * (land + 10000) * Race Mod * Personality Mod * Mills Mod * Double Speed * Haste Ritual Mod * Artisan Science Mod
```
...
```
Raze Costs = (300 + (0.05 * Total land)) * Artisan Science Mod * Race Mod * Personality Mod
```
...
- Building Efficiency affects **ALL** [Production](Growth.md) and [Percentage-Based](Growth.md) buildings.
- Building Efficiency has **NO** effect on Capacity or Fixed Rate components.
...
Production Buildings = Base Effect * Number of Buildings * BE
```
